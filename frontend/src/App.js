...
import AdminDashboard from "./Dashboard/AdminAdditems";
    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/imported"
            element={<Imported onAddToCartGlobal={handleAddToCart} />}
          />
          <Route path="/freshfruits" element={<Freshfruits />} />
          <Route
            path="/imageclick"
            element={<Imageclick onAddToCartGlobal={handleAddToCart} />}
          />
